...
Future<void> main() async {
  ...
  Workmanager().registerPeriodicTask(
    ...
    frequency: const Duration(minutes: 10), // Set the frequency of the task
  );
  ...
  runApp(
    ChangeNotifierProvider(
      ...
      child: MyApp(
        initialRoute:
            l_driverID != null && l_driverID.isNotEmpty ? AppRoutes.vwCommonLayout : AppRoutes.initialRoute,
      ),
    ),
  );
}
