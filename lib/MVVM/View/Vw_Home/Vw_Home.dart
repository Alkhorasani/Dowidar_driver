...
class _Vw_HomeState extends State<Vw_Home> {
  ...
  void initState() {
    ...
    initialRoute = Get.arguments?['initialRoute'] ?? 0;

    // Now you can use the initialRoute value as needed
                        ...
                        Obx(() {
                          return GlowSwitch(
                            onChanged: (value) async {
                              if (value) {
                                print("Switch on");
                                cmGlobalVariables.pBDriverStatus = "active";
                                    ...
                                    children: [
                                      GestureDetector(
                                        onTap: () {
                                          ...
                                          l_Vm_Home.isSelectedAll.value = true;
                                          l_Vm_CommonLayout.fnc_GetAllOrders();
                                        ...
                                        child: Obx(() {
                                          return Container(
                                            decoration: BoxDecoration(
                                              color: l_Vm_Home.isSelectedAll.value == true
                                                  ? Colors.indigo
                                            ...
                                            child: Padding(
                                                ...
                                                child: Text(
                                                  "${'${cm_StringConstantsVwHome.strAll}'.tr}",
                                                  style: GoogleFonts.ubuntu(
                                                    textStyle: const TextStyle(
                                                              ...
                                                              return Row(
                                                                ...
                                                                children: [
                                                                  ElevatedButton(
                                                                    ...
                                                                    child: Text(
                                                                      "${'${cm_StringConstantsVwHome.strOrderAccepted}'
                                                                          .tr}",
                                                                      style: GoogleFonts.ubuntu(
                                                                        textStyle: const TextStyle(
                                                                          fontWeight: FontWeight.w800,
                                                                  ...
                                                                  ElevatedButton(
                                                                    ...
                                                                    child: Text(
                                                                      "${'${cm_StringConstantsVwHome.strOrderRejected}'
                                                                          .tr}",
                                                                      style: GoogleFonts.ubuntu(
                                                                        textStyle: const TextStyle(
                                                                          fontWeight: FontWeight.w800,
