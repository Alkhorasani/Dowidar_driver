...
_handleOnTapNotification(message) {
  ...
  BannerNotificationPayload.fromRawJson(message.data["payload"]);
  cm_HandleDeepLink().handleDeepLink(
      context: _context,
      deeplink: notificationPayload.type!,
      payLoad: notificationPayload.id);
}
...
class FirebaseService {
  ...
  static Future<void> initializeLocalNotifications() async {
    ...
    await FirebaseService._localNotificationsPlugin.initialize(initSettings,onDidReceiveNotificationResponse: FCMProvider.handleOnTapNotification );
...
class FCMProvider with ChangeNotifier {
  ...
  static Future<void> handleOnTapNotification(NotificationResponse? response) async {
    ...
    BannerNotificationPayload notificationPayload =
    BannerNotificationPayload.fromJson(_data);
    cm_HandleDeepLink().handleDeepLink(
        context: _context,
        deeplink: notificationPayload.type!,
        payLoad: notificationPayload.id);
